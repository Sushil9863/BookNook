...
<head>
    <title>Confirmation Page | BookNook</title>
...
<body>
    <form action="https://rc-epay.esewa.com.np/api/epay/main/v2/form" method="POST" class="bmc-button" id="form">
        ...
        <input type="hidden" id="success_url" name="success_url" value="http://localhost/BookNook/index.php" required>
        <input type="hidden" id="failure_url" name="failure_url" value="http://localhost/BookNook/index.php" required>
        ...
        <center class="confirmation">
            ...
            <input value="Cancel" type="reset" name="cancel" class="cancel-button" onclick="window.location.href='http://localhost/BookNook/index.php'">
            <i class='bx bx-x'></i>
        </center>
    </form>
</body>
