      ...
      <table class="min-w-full bg-transparent table">
        <thead class="bg-gray-800 text-white">
          <tr>
            ...
            <th class="py-2 px-4">Registration Date</th>
        ...
        <tbody>
          <tr class="border-b">
            ...
            <td class="py-2 px-4"><span class="text-green-500">Active</span></td>
            <td class="py-2 px-4">
          ...
          <tr class="border-b bg-gray-100">
            ...
            <td class="py-2 px-4">2023-02-10</td>
            <td class="py-2 px-4"><span class="text-red-500">Suspended</span></td>
            <td class="py-2 px-4">
          ...
          <tr class="border-b">
            ...
            <td class="py-2 px-4">bob.johnson@example.com</td>
            <td class="py-2 px-4">2023-03-05</td>
            <td class="py-2 px-4"><span class="text-green-500">Active</span></td>
            <td class="py-2 px-4">
              <button class="btn btn-edit">Edit</button>
              <button class="btn btn-delete">Delete</button>
