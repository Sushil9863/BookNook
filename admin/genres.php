...
<body>
    <div id="main">
        <button class="openbtn" onclick="openNav();" style="width:90px; border-radius:10px;">
            <i class="fa fa-list" style="font-size:60px;"></i>
        </button>
    </div>
        ...
        <div class="overflow-x-auto bg-transparent shadow-md rounded-lg p-6">
            <table class="min-w-full bg-transparent table">
                <thead class="bg-gray-800 text-white">
                    <tr>
                        <th class="py-2 px-4">Genre ID</th>
                        <th class="py-2 px-4">Genre Name</th>
                ...
                <tbody>
                    ...
                    <tr class="border-b">
                        ...
                        <td class="py-2 px-4">Romantic</td>
                        <td class="py-2 px-4">
                            <div class="action-buttons">
                                <button class="btn btn-edit">Edit</button>
                                <button class="btn btn-delete">Delete</button>
...
<div class="add-genres-container">
  <button class="btn btn-add-genres">Add More Genres</button>
</div>
