...
<body>
  ...
  <section class="filter-buttons">
    <a href="orders.php?status=Pending" class="filter-btn">Pending</a>
    <a href="orders.php?status=Completed" class="filter-btn">Completed</a>
  </section>
  ...
  <section class="show-products">
    <div class="box-container">
      ...
      $select_genres = mysqli_query($conn, "SELECT * FROM orders WHERE payment_status = '$status'") or die('query failed');
      ...
      <?php
         ...
         echo '<p class="empty">No Orders Found for ' . $status . ' Status!</p>';
      }
      ?>
    </div>
  </section>
