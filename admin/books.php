...
<body>
  <div id="main">
    <button class="openbtn" onclick="openNav();" style="width:90px; border-radius:10px;"><i class="fa fa-book" style="font-size:60px;"></i></button>
  </div>
...
<div class="container mx-auto my-8">
      ...
      <table class="min-w-full bg-transparent table">
        ...
        <tbody>
          <tr class="border-b">
            ...
            <td class="py-2 px-4">F. Scott Fitzgerald</td>
            <td class="py-2 px-4">Classic</td>
            <td class="py-2 px-4">$10.99</td>
          ...
          <tr class="border-b bg-gray-100">
            ...
            <td class="py-2 px-4">Harper Lee</td>
            <td class="py-2 px-4">Fiction</td>
            <td class="py-2 px-4">$7.99</td>
          ...
          <tr class="border-b">
            ...
            <td class="py-2 px-4">George Orwell</td>
            <td class="py-2 px-4">Dystopian</td>
            <td class="py-2 px-4">$8.99</td>
  ...
  <button class="btn btn-add-book">Add More Books</button>
</div>
