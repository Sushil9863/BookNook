...
if(isset($_POST['add_product'])) {
  ...
  if(mysqli_num_rows($select_product_name) > 0) {
     ...
     $add_product_query = mysqli_query($conn, "INSERT INTO `products`(name, genre, price, author_id, image, stocks) VALUES('$name','$genre', '$price', '$author_id', '$image', '$stock')") or die('query failed');
